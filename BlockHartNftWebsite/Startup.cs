...
using AutoMapper;
using BlockHartNftWebsite.Authorization;
using BlockHartNftWebsite.Helpers;
using DAL;
using DAL.Core;
	...
	public class Startup
	{
		...
		public void ConfigureServices(IServiceCollection services)
		{
			...
			services.AddDbContext<ApplicationDbContext>(options =>
				options.UseSqlServer(Configuration["ConnectionStrings:DefaultConnection"], b => b.MigrationsAssembly("BlockHartNftWebsite")));
		...
		public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
		{
			...
			app.UseSwaggerUI(c =>
			{
				c.DocumentTitle = "Swagger UI - BlockHartNftWebsite";
